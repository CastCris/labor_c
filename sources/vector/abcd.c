...
# 16 "main.c"
    ...
    (vct_replace((tst),(0),(void*)(replace),(strlen(replace)+1)));

    char hello[]="Hello World!";
    (vct_append((tst),(void*)(hello),(sizeof(hello))));
    (vct_insert((tst),(0),(void*)(hello),(sizeof(hello))));
...
# 33 "main.c" 3 4
   ((void *)0)
# 33 "main.c"
   :vctItem_item((((tst))->items[((0))])))))?
# 33 "main.c" 3 4
   ((void *)0)
# 33 "main.c"
   : vct_item_get((tst),(0),(void**)&(my_str)));
    my_str[0]='X';
    printf("%s\n",my_str);
...
# 38 "main.c" 3 4
   ((void *)0)
# 38 "main.c"
   : vct_item_get((tst),(0),(void**)&(my_str2)));
    printf("%s\n",my_str2);
    ...
    char*item=(!(((!(!((((tst))->items[((0))]))?
# 46 "main.c" 3 4
             ((void *)0)
# 46 "main.c"
             :vctItem_item((((tst))->items[((0))]))))))?vct_pop((tst),(0)):
# 46 "main.c" 3 4
             ((void *)0)
# 46 "main.c"
             );
...
# 52 "main.c" 3 4
   ((void *)0)
# 52 "main.c"
   :vctItem_item((((tst))->items[((0))]))))))? vct_popup((tst),(0),(void**)&item2):
# 52 "main.c" 3 4
   ((void *)0)
# 52 "main.c"
   );
